...
export function PolymarketTradesFeed() {
  ...
  return (
    <Tabs
      ...
      onValueChange={(v) => { if (v === 'history') fetchHistTrades() }}
    >
    ...
    <Card className="gap-0 py-0">
      ...
      >
        <div className="flex items-center gap-2 min-w-0">
          <Badge variant="secondary" className="shrink-0 text-xs tabular-nums">{trades.length}</Badge>
      ...
      {open && (
        <>
          ...
          <ScrollArea className="h-72" viewportRef={viewportRef}>
            <div style={{ height: `${virtualizer.getTotalSize()}px`, position: 'relative' }} className="p-3">
