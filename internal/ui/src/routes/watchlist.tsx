      ...
      <header className="sticky top-0 z-10 border-b bg-background/90 backdrop-blur-sm px-6 py-3 flex items-center justify-between">
        <div className="flex items-center gap-4">
          ...
          <nav className="flex items-center gap-3 text-sm">
            ...
            <Link to="/options" className="text-muted-foreground hover:text-foreground transition-colors">
              Options
            </Link>
            <Link to="/futures" className="text-muted-foreground hover:text-foreground transition-colors">
              Futures
            </Link>
          </nav>
        </div>
...
function WatchlistCard({
  ...
  // dot only when user has customized away from defaults
  ...
  return (
    <Card
      className={`py-4 gap-2 transition-colors ${selected ? 'border-primary/50 bg-primary/5' : ''}`}
    >
